...
pub enum StitcherError {
    ...
    #[fail(display = "an image error occurred")]
    ImageError(#[cause] image::ImageError),

    #[fail(display = "Command line parsing")]
    CommandLineParsingError,

    #[fail(display = "Image size mismatch")]
    SizeMismatch,
...
fn copy_into(img: &mut image::RgbaImage, src: &DynamicImage, x: u32, y: u32, width: u32, height: u32) -> Result<()> {
